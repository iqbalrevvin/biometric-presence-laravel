...
class TagCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        $this->crud->addField([
            ...
            'name' => 'artikel', // the relationship name in your Model
            'entity' => 'artikel', // the relationship name in your Model
    ...
    public function store()
    {
        ...
        if (backpack_user()->id == 2) {

            $this->crud->getRequest()->request->add(['user_id' => backpack_user()->id]);
            $response = $this->traitStore();
            return $response;
        } else {
            \Alert::add('danger', 'Pengguna Tidak Di izinkan')->flash();
